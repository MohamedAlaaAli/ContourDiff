...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default="lowHigh", help="name of the dataset")
    ...
    parser.add_argument('--noise_step', type=int, default=200, help="maximum number of steps to add noise during training")
    ...
    parser.add_argument('--overwrite', default=True, help="overwrite previous checkpoints if specified, otherwise, save checkpoints separately")
    ...
    parser.add_argument('--contour_guided', default=True, help="enable contour guided diffusion if specified")
    parser.add_argument('--contour_channel_mode', type=str, default="single", help="number of channels for the contour")
    parser.add_argument('--conditional', default=True, help="if adding other conditions (except from contours) to generate images")
    
    parser.add_argument('--data_directory', type=str, default="dataset",required=False, help="directory of the dataset")
    parser.add_argument('--input_domain', type=str, default="lf",required=False, help="name of the input domain (e.g. CT)")
    parser.add_argument('--output_domain', type=str, default="hf",required=False, help="name of the output domain (e.g. MRI)")
    parser.add_argument('--input_domain_img_folder', default="lf/train/img" ,type=str, required=False, help="name of the folder containing images from input domain (e.g. CT)")
    parser.add_argument('--input_domain_contour_folder', default="lf/train/contours",type=str, required=False, help="name of the folder containing contours from input domain (e.g. CT)")
    parser.add_argument('--output_domain_img_folder', default="hf/img",type=str, required=False, help="name of the folder containing images from output domain (e.g. MRI)")
    parser.add_argument('--output_domain_contour_folder', default="hf/contours",type=str, required=False, help="name of the folder containing contours from output domain (e.g. MRI)")
