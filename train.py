...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_directory', type=str, default="dataset",required=True, help="directory of the dataset")
    parser.add_argument('--input_domain', type=str, default="lf",required=True, help="name of the input domain (e.g. CT)")
    parser.add_argument('--output_domain', type=str, default="hf",required=True, help="name of the output domain (e.g. MRI)")
    parser.add_argument('--input_domain_img_folder', default="lf/train/img" ,type=str, required=True, help="name of the folder containing images from input domain (e.g. CT)")
    parser.add_argument('--input_domain_contour_folder', default="lf/train/contours",type=str, required=True, help="name of the folder containing contours from input domain (e.g. CT)")
    parser.add_argument('--output_domain_img_folder', default="hf/img",type=str, required=True, help="name of the folder containing images from output domain (e.g. MRI)")
    parser.add_argument('--output_domain_contour_folder', default="hf/contours",type=str, required=True, help="name of the folder containing contours from output domain (e.g. MRI)")
